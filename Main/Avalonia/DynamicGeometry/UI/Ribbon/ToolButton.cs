...
namespace DynamicGeometry
{
    ...
    {
        // Avalonia matches theme templates by concrete type; keep using the UserControl template.
        protected override System.Type StyleKeyOverride => typeof(UserControl);
